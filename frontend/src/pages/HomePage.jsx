          ...
          <div className="flex items-center gap-3">
            <div className="relative flex h-9 w-9 items-center justify-center">
              <svg className="h-8 w-8" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <linearGradient id="home-logo-grad" x1="2" y1="2" x2="30" y2="30" gradientUnits="userSpaceOnUse">
                    <stop offset="0%" stopColor="#66D1C1" />
                    <stop offset="40%" stopColor="#0ea5e9" />
                    <stop offset="100%" stopColor="#0D6EFD" />
                  </linearGradient>
                  <linearGradient id="home-logo-accent" x1="30" y1="2" x2="2" y2="30" gradientUnits="userSpaceOnUse">
                    <stop offset="0%" stopColor="#38bdf8" stopOpacity="0.8" />
                    <stop offset="100%" stopColor="#818cf8" stopOpacity="0" />
                  </linearGradient>
                </defs>
                <circle cx="16" cy="16" r="14" fill="url(#home-logo-grad)" opacity="0.15" className="animate-pulse" />
                <path 
                ...
                <circle cx="16" cy="16" r="7" stroke="url(#home-logo-accent)" strokeWidth="1.5" />
              </svg>
            </div>
            <div>
